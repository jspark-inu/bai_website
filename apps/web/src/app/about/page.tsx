  ...
  return (
    <main className="bai-about">
      ...
      <section className="bai-about-grid">
        <article><b>요청</b><h2>학과 구성원이 문제를 제안합니다.</h2><p>개인 민원이 아니라 여러 사람이 반복해서 겪는 시스템 문제를 다룹니다.</p></article>
        <article><b>제작</b><h2>학생이 해결하고 검증합니다.</h2><p>BAI 학생은 요청자와 대화하고, 결과물을 만들고, 사용자가 확인할 수 있게 남깁니다.</p></article>
        <article><b>성장</b><h2>기여가 다음 서비스를 만듭니다.</h2><p>검증된 경험은 개인의 포트폴리오가 되고, 장차 길드가 운영하는 실제 서비스로 이어집니다.</p></article>
      </section>
